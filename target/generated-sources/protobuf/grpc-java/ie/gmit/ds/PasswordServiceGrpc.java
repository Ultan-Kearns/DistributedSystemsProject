...
public final class PasswordServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ie.gmit.ds.Hash,
      ie.gmit.ds.HashResponse> getHashServiceMethod;
  ...
  public static io.grpc.MethodDescriptor<ie.gmit.ds.Hash,
      ie.gmit.ds.HashResponse> getHashServiceMethod() {
    io.grpc.MethodDescriptor<ie.gmit.ds.Hash, ie.gmit.ds.HashResponse> getHashServiceMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<ie.gmit.ds.Validate,
      ie.gmit.ds.ValidateResponse> getValidateServiceMethod;
  ...
  public static io.grpc.MethodDescriptor<ie.gmit.ds.Validate,
      ie.gmit.ds.ValidateResponse> getValidateServiceMethod() {
    io.grpc.MethodDescriptor<ie.gmit.ds.Validate, ie.gmit.ds.ValidateResponse> getValidateServiceMethod;
      ...
      synchronized (PasswordServiceGrpc.class) {
        if ((getValidateServiceMethod = PasswordServiceGrpc.getValidateServiceMethod) == null) {
          PasswordServiceGrpc.getValidateServiceMethod = getValidateServiceMethod =
              io.grpc.MethodDescriptor.<ie.gmit.ds.Validate, ie.gmit.ds.ValidateResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
  ...
  public static abstract class PasswordServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void hashService(ie.gmit.ds.Hash request,
    ...
    /**
     */
    public void validateService(ie.gmit.ds.Validate request,
  ...
  public static final class PasswordServiceBlockingStub extends io.grpc.stub.AbstractStub<PasswordServiceBlockingStub> {
     ...
     * </pre>
     */
    public ie.gmit.ds.HashResponse hashService(ie.gmit.ds.Hash request) {
    ...
    /**
     */
    public ie.gmit.ds.ValidateResponse validateService(ie.gmit.ds.Validate request) {
      return blockingUnaryCall(
  ...
  public static final class PasswordServiceFutureStub extends io.grpc.stub.AbstractStub<PasswordServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<ie.gmit.ds.HashResponse> hashService(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ie.gmit.ds.ValidateResponse> validateService(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HASH_SERVICE:
          serviceImpl.hashService((ie.gmit.ds.Hash) request,
              (io.grpc.stub.StreamObserver<ie.gmit.ds.HashResponse>) responseObserver);
          break;
        case METHODID_VALIDATE_SERVICE:
          serviceImpl.validateService((ie.gmit.ds.Validate) request,
              (io.grpc.stub.StreamObserver<ie.gmit.ds.ValidateResponse>) responseObserver);
          break;
        default:
